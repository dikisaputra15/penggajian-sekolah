				...
				<div class="box-body">
					<div class="panel-body">
						<?php
							...
							backup_tables("localhost","root","","db_penggajian",$file);
						?>
						<p align="center">Backup database telah berhasil !</p><br />
						<p align="center"><a style="cursor:pointer" onclick="location.href='module/data_input/proses_backup.php?nama_file=<?php echo $file;?>'" title="Download">Download file database</a></p>
						<?php
						/*
						...
						*/
						function backup_tables($host,$user,$pass,$name,$nama_file,$tables ='*')	{
							...
							$handle = fopen('module/data_input/backup/'.$nama_file,'w+');
