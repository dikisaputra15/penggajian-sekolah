...
$pdf->Cell(0,5,'slip pembayaran gaji','0','1','C',false);
...
tb_pembayaran.kd_jabatan where nama_guru='$nama_guru' and tgl between '$tgl1' and '$tgl2'") or die(mysql_error());
...
$total_all += $total;
	...
	$pdf->Cell(40,4,$data['nama_jabatan'],1,0,'L');
...
$pdf->Ln(5);
$pdf->Cell(0,5,"Total Uang Yang Diterima"." "."$total_all");
